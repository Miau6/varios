  ...
  dashboardBody(
    ...
    tabItems(
     ...
     tabItem(tabName = "Ind21",
             ...
             box(
               ...
               fluidRow(
                 ...
                 #   inputId = "ind_21_edad",
                 #   label = "Selecciona el rango de edad",
                 #   choices = unique(sort(indicador_21$Rango)),
                 #   multiple = TRUE
                 # )
                 # )#,
                 #downloadButton("downloadData_ind_1", "Descarga (.csv)")
               ...
               fluidRow(
                 ...
                 # h6("Fuente: Datos proporcionados por IJCF."),br(),
                 # column(6,plotlyOutput("gr21",  height = "auto", width = "auto"))
               ),
               fluidRow(column(8, offset = 1,
                               h6("Fuente: Datos proporcionados por Secretaría de Salud y OPD Servicios de Salud Jalisco.")), br()
               )
     ...
     #####
      ...
      #                                     multiple = TRUE
      #                                     # selected = c("Violencia familiar (física)", "Violencia familiar (psicológica)",
      #                                     #              "Lesiones", "Amenazas", "Abuso sexual infantil",
     ...
     tabItem(tabName = "Ind37",
             ...
             box(
               ...
               fluidRow(
                 # div(class="display dataTable no-footer",
                 column(10,dataTableOutput("t_37", height = "auto", width = "auto")),
                 # h6("Fuente: Datos proporcionados por IJCF."),br(),
                 # column(8,plotlyOutput("gr37",  height = "auto", width = "auto"))
               ),
               fluidRow(column(8, offset = 1,
                               h6("Fuente: Datos proporcionados por Fiscalía del Estado de Jalisco.")), br()
               )
     ...
     #####
      ...
      #                                # br(), br(), 
      #                                # dataTableOutput("t_40_1", height = "auto", width = "auto"),
      #                                h6("Fuente: Datos proporcionados por Fiscalía del Estado de Jalisco."),br(),
